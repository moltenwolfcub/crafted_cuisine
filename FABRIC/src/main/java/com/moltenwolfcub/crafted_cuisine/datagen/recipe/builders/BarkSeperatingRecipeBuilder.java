...
public class BarkSeperatingRecipeBuilder implements RecipeBuilder {
    ...
    public BarkSeperatingRecipeBuilder(RecipeCategory recipeCategory, Block inputBlock, Block outputBlock, ItemLike bark) {
    ...
    public static class Result implements FinishedRecipe {
        ...
        public ResourceLocation getId() {
            return new ResourceLocation(CraftedCuisine.MODID, "bark/" + BuiltInRegistries.ITEM.getKey(this.result).getPath() +"_from_stripping_"+ BuiltInRegistries.BLOCK.getKey(this.inputBlock).getPath());
        }
