...
public class ModChestLoot implements LootTableSubProvider {
    ...
    public void generate(BiConsumer<ResourceLocation, Builder> builder) {
        ...
        builder.accept(BARK_CHEST, LootTable.lootTable()
            .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 5.0F))
                .add(LootItem.lootTableItem(AllItems.ACACIA_BARK).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0f, 10.0f))))
    ...
    private static void addBlackstoneFortress(BiConsumer<ResourceLocation, Builder> builder) {
        builder.accept(DEFAULT_CHEST, LootTable.lootTable()
            .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0f, 6.0f))
                ...
                .add(LootItem.lootTableItem(AllItems.REINFORCED_BLACKSTONE_NUGGET)
                    .setWeight(18)
                ...
                .add(LootItem.lootTableItem(AllItems.REINFORCED_BLACKSTONE_INGOT)
                    .setWeight(15)
                    .apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0f, 4.0f)))
                )
                .add(LootItem.lootTableItem(AllItems.REINFORCED_BLACKSTONE_SWORD)
                    .setWeight(13)
                ...
                .add(LootItem.lootTableItem(AllBlockItems.REINFORCED_BLACKSTONE)
                    .setWeight(3)
        ...
        builder.accept(ARMORY_CHEST, LootTable.lootTable()
            .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(3.0f, 5.0f))
                ...
                .add(LootItem.lootTableItem(AllItems.REINFORCED_BLACKSTONE_CHESTPLATE)
                    .setWeight(18)
                    .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                    .apply(EnchantRandomlyFunction.randomApplicableEnchantment())
                )
                .add(LootItem.lootTableItem(AllItems.REINFORCED_BLACKSTONE_AXE)
                    .setWeight(17)
                    .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                    .apply(EnchantRandomlyFunction.randomApplicableEnchantment())
                )
                .add(LootItem.lootTableItem(AllItems.REINFORCED_BLACKSTONE_NUGGET)
                    .setWeight(15)
                    .apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0f, 20.0f)))
                )
                .add(LootItem.lootTableItem(Items.IRON_SWORD)
                    .setWeight(13)
                    .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                )
                .add(LootItem.lootTableItem(AllItems.REINFORCED_BLACKSTONE_LEGGINGS)
                    .setWeight(13)
                    .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                    .apply(EnchantRandomlyFunction.randomApplicableEnchantment())
                )
                ...
                .add(LootItem.lootTableItem(AllItems.REINFORCED_BLACKSTONE_HELMET)
                    .setWeight(13)
                    .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                    .apply(EnchantRandomlyFunction.randomApplicableEnchantment())
                )
                .add(LootItem.lootTableItem(AllItems.REINFORCED_BLACKSTONE_BOOTS)
                    .setWeight(11)
                    .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1)))
                    .apply(EnchantRandomlyFunction.randomApplicableEnchantment())
                )
        ...
        builder.accept(LAVA_CHEST, LootTable.lootTable()
            .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0f, 4.0f))
                .add(LootItem.lootTableItem(Items.MAGMA_CREAM)
                    .setWeight(10)
                    .apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0f, 13.0f)))
                )
        ...
        builder.accept(BUILDING_CHEST, LootTable.lootTable()
            .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(3, 6))
                ...
                .add(LootItem.lootTableItem(AllBlockItems.REINFORCED_BLACKSTONE_GRAVEL)
                    .setWeight(6)
        ...
        builder.accept(PRISON_CHEST, LootTable.lootTable()
            .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1, 4))
                ...
                .add(LootItem.lootTableItem(AllBlockItems.SAW_DUST).setWeight(1))
            )
        );
    }
