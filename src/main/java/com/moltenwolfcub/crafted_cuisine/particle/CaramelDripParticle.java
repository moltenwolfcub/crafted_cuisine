...
public class CaramelDripParticle extends TextureSheetParticle {
    ...
    public static class CaramelFallAndLandParticle extends CaramelFallingParticle {
        ...
        public static class Provider implements ParticleProvider<SimpleParticleType> {
            ...
            @Override
            public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double x, double y, double z, double dx, double dy, double dz) {
                CaramelFallAndLandParticle particle = new CaramelFallAndLandParticle(clientLevel, x, y, z, AllParticles.LANDING_CARAMEL);
    ...
    @Environment(value=EnvType.CLIENT)
    public static class CaramelDripLandParticle extends CaramelDripParticle {
        public CaramelDripLandParticle(ClientLevel clientLevel, double d, double e, double f) {
            super(clientLevel, d, e, f);
        ...
        public static class Provider implements ParticleProvider<SimpleParticleType> {
            ...
            @Override
            public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double x, double y, double z, double dx, double dy, double dz) {
                CaramelDripLandParticle particle = new CaramelDripLandParticle(clientLevel, x, y, z);
                particle.setColor(0.412f, 0.224f, 0.027f);
                particle.pickSprite(this.sprites);
                return particle;
            }
