...
import com.moltenwolfcub.cooks_kitchen.item.FurnaceFuelBlockItem;
...
public class ModBlockItems {
    public static final DeferredRegister<Item> BLOCK_ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, CooksKitchen.MODID);
