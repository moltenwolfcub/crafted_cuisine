...
public class CarameliserRecipeCategory implements IRecipeCategory<CarameliserRecipe> {
    ...
    public final static ResourceLocation UID = new ResourceLocation(CooksKitchen.MODID, "caramelising");
    public final static ResourceLocation TEXTURE = new ResourceLocation(CooksKitchen.MODID, "textures/gui/carameliser.png");
    ...
    public Component getTitle() {
        return new TextComponent("Caramelising");
    }
