...
import com.moltenwolfcub.create_food.item.util.ItemUtils;
...
public class ModBlockItems {
    public static final DeferredRegister<Item> BLOCK_ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, CreateFood.MODID);
